...
His current research interests lie in materials informatics, especially battery degradation prediction (battery life prediction, battery degradation trajectory forecasting, and state of health estimation) and AI-driven materials optimization. He has contributed to or advised several influential open-source projects, including [Time-Series-Library](https://github.com/thuml/Time-Series-Library), [BatteryML](https://github.com/microsoft/BatteryML), [BatteryLife](https://github.com/Ruifeng-Tan/BatteryLife), and [Bgolearn](https://github.com/Bin-Cao/Bgolearn). More details can be found in his [Google Scholar](https://scholar.google.com/citations?hl=zh-CN&view_op=list_works&gmla=AC6lMd8PIH28jI9lFlL_C9WwIrKkPBVFLJ4Q4yxwypYTF9x3S1TySXmdp1jXnovKUUB0Hef-DqMoRood9idOPGrsI-ZUPl0&user=XAGG2pIAAAAJ).

## News

- [July 2026] I will give an invited talk at [China Materials Conference 2026-FB06](https://cmc2026.scimeeting.cn/cn/web/index/35126_3062537_149158).
- [May 2026] BatteryMFormer was accepted by KDD (Top-tier data mining conference).
- [May 2026] PBT won the Best Poster Award at 3rd International AI4Materials Forum.
...
## Some Publications <small style="font-weight: normal;"><a href="/publications/">Full List</a></small>
